# cloud-itonami-lei-549300jz4okehw3dpj59

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by Visa Inc..**

This repository archives publicly published legal/policy documents of
**Visa Inc.**, with source-url and retrieval-date provenance, per
...
- **Legal name**: Visa Inc.
- **LEI (ISO 17442)**: [549300JZ4OKEHW3DPJ59](https://search.gleif.org/#/record/549300JZ4OKEHW3DPJ59) (GLEIF-verified)
- **Jurisdiction**: US-DE
...
live fetch of the company's current privacy notice and no live `kotoba-server`/CACAO
