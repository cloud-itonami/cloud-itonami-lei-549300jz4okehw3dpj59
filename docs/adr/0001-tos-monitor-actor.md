...
This repository archives the publicly published Global Privacy Notice of
Visa Inc., per ADR-2607110300 -- a read-only reference archive. As part of a
fourth 10-repo validation batch extending the
...
- **Company**: Visa Inc., LEI 549300JZ4OKEHW3DPJ59, website
  `https://www.visa.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.visa.com/en-us/legal/global-privacy-notice`,
  retrieved-at `2026-07-19`, doc-type `:privacy-policy`.
