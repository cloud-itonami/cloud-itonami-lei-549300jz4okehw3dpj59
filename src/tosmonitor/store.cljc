(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Visa Inc., LEI
  549300JZ4OKEHW3DPJ59) -- unlike `commitledger.store`'s multi-application
  directory, this Store holds a SINGLE `:company` record and a SINGLE
  `:baseline` record (the latest archived privacy-notice snapshot this
...
(def ^:private demo-full-text
  "Global Privacy Notice\nAs a global payments technology company, Visa Inc. collects, uses, and shares Personal Information when you use Visa or our clients' products, services, offers, and promotions, including data needed to process payment transactions and detect fraud. This Notice is provided for informational purposes only and is subject to change without notice. These Terms are governed by the laws of the State of Delaware.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.visa.com/en-us/legal/global-privacy-notice"
